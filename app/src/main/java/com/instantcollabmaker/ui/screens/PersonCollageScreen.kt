...
fun PersonCollageScreen(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "${person.displayName}'s Collage",
            ...
            Text(
                text = "This collage shows the best frame from each appearance of ${person.displayName} in your video. Frames are selected based on clarity, expression quality, and face angle.",
                style = FtType.body,
                color = FtColor.TextSecondary,
